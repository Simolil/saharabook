            ...
            >
              ...
              <span
                className={cn(
                  ...
                  step >= s.number ? "text-[#0B132B]" : "text-gray-300",
                )}
              >
                {s.name}
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                  className="bg-[#FAF7F2] p-8 md:p-12 rounded-[40px] shadow-sm border border-[#BA7517]/15"
                >
                  <h2 className="text-3xl font-bold tracking-tighter text-[#0B132B] mb-8">
                  ...
                  <button
                    onClick={nextStep}
                    className="mt-12 w-full bg-[#BA7517] text-white py-4 rounded-lg md:rounded-xl font-bold flex items-center justify-center space-x-2"
                  >
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-2 block">
                        WhatsApp Number (For Operator Contact)
                      </label>
                      <input
                        type="tel"
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-12">
                    <button
                      onClick={prevStep}
                      className="bg-gray-100 text-[#0B132B] py-4 rounded-lg md:rounded-xl font-bold flex items-center justify-center space-x-2"
                    >
                      <ArrowLeft size={18} />
                      <span>Back</span>
                    </button>
                    <button
                      onClick={nextStep}
                      className="bg-[#BA7517] text-white py-4 rounded-lg md:rounded-xl font-bold flex items-center justify-center space-x-2"
                    >
              ...
              {step === 3 && (
                ...
                >
                  ...
                  <div className="bg-[#0B132B] p-8 rounded-3xl text-white mb-8">
                    <div className="flex justify-between items-start mb-12">
                      <h3 className="text-xl font-bold tracking-tight">
                        <span className="text-[#BA7517]">D</span>unecamps
                        <span className="text-[#BA7517]">pay</span>
                      </h3>
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-green-50 rounded-2xl border border-green-100 mb-8">
                    ...
                    <span className="text-xs text-green-800 font-medium">
                      Your payment is held in escrow until check-in.
                    </span>
                  </div>
                  <button
                    onClick={nextStep}
                    className="w-full bg-[#BA7517] text-white py-4 rounded-lg md:rounded-xl font-bold flex items-center justify-center space-x-2"
                  >
              ...
              {step === 4 && (
                <motion.div
                  ...
                  className="bg-[#FAF7F2] p-8 md:p-12 rounded-[40px] shadow-2xl border border-[#BA7517]/15 text-center"
                >
                  <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-8 border-4 border-[#FAF7F2] shadow-xl">
                    <Check className="text-green-600" size={40} />
                  </div>
                  <h2 className="text-3xl font-bold tracking-tighter text-[#0B132B] mb-4">
                    You're going to the Sahara!
                  </h2>
                  <p className="text-gray-500 mb-12">
                    Booking ID:{" "}
                    <span className="text-[#BA7517] font-bold">BV-88219-X</span>
                  </p>

                  {/* Offline Voucher */}
                  <div className="bg-[#FAF7F2] p-8 rounded-3xl border-2 border-dashed border-[#BA7517]/20 relative">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-[10px] font-bold uppercase tracking-widest text-[#BA7517]">
                      Official Voucher
                    </div>
                    ...
                    <div className="flex justify-between mb-8 text-left">
                      ...
                      <div className="text-right">
                        ...
                        <p className="font-bold text-[#0B132B]">May 14, 2026</p>
                      </div>
                    </div>

                    <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 flex justify-center">
                      <QRCodeSVG
                        value={`https://dunecamps.com/v/${Math.random().toString(36).substr(2, 9)}`}
                        size={120}
                        fgColor="#0B132B"
                      />
                    </div>
                  ...
                  <div className="mt-12 space-y-4">
                    <p className="text-xs text-gray-400 italic">
                      This voucher has been saved for offline access.
                    </p>
                    <Link
                      to="/"
                      className="inline-block text-[#BA7517] font-bold text-sm underline underline-offset-4"
                    >
                      Return Home
                    </Link>
                  </div>
          ...
          {step < 4 && (
            <div className="md:col-span-1">
              <div className="bg-[#FAF7F2] p-8 rounded-3xl border border-[#BA7517]/15 shadow-sm sticky top-28">
                ...
                <div className="flex space-x-4 mb-6 pb-6 border-b border-gray-50">
                  ...
                  />
                  <div>
                    <h4 className="font-bold text-sm text-[#0B132B]">
                      {camp.name}
                    </h4>
                    <p className="text-[10px] text-[#BA7517] uppercase font-bold tracking-widest mt-1">
                      {camp.destination}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center pt-6 border-t border-gray-100">
                  ...
                  <span className="text-xl font-bold text-[#0B132B]">
                    {formatCurrency(440)}
                  </span>
                </div>
              </div>
