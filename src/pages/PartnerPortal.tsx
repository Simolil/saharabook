...
export default function PartnerPortal() {
  ...
  return (
    <div className="bg-[#FAF7F2] min-h-screen">
      <Helmet>
        <title>Operator Portal | SaharaBook.ma Partners</title>
      </Helmet>
            ...
            <div className="lg:col-span-3">
               {activeTab === 'onboarding' && (
                 <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <h2 className="text-3xl font-bold tracking-tighter text-[#26215C] mb-8">List your camp on <span className="text-[#BA7517]">SaharaBook.ma</span></h2>
