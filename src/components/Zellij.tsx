...
export const StarZellij = ({ className, color1 = "#BA7517", color2 = "#0B132B" }: { className?: string, color1?: string, color2?: string }) => (
...
export const ZellijCorner = ({ className, light = false }: { className?: string, light?: boolean }) => (
  <div className={cn("pointer-events-none select-none", className)}>
    ...
    >
      <StarZellij className="w-24 h-24 opacity-20 rotate-12" color1={light ? "#FFF" : "#BA7517"} color2={light ? "#BA7517" : "#0B132B"} />
      <StarZellij className="w-16 h-16 absolute -top-4 -left-8 opacity-15 -rotate-12" color1={light ? "#FAF7F2" : "#0B132B"} />
