...
export default function DateRangePicker({
  ...
  const calendarCard = (
    <div 
      ...
      className="w-[340px] sm:w-[380px] max-w-[calc(100vw-2rem)] max-h-[min(560px,calc(100vh-130px))] overflow-y-auto bg-[#0B132B] border border-[#BA7517]/60 rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.95)] ring-1 ring-white/10 p-4 sm:p-5 md:p-6 text-white relative animate-in fade-in zoom-in-95 duration-200"
  ...
  if (isMobile && typeof document !== 'undefined') {
    return createPortal(
      <div 
        className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4 bg-black/40 backdrop-blur-xs overflow-y-auto"
        onClick={(e) => {
  ...
  // On desktop/tablet, render anchored above (top) or below (bottom) the search bar
  return (
    <div 
      data-search-picker="true"
      className={cn(
        "absolute left-0 sm:left-[10%] md:left-[18%] lg:left-[22%] z-[100]",
